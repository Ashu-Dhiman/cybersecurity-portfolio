...
function isDisabled(elem) {
    ...
    // previously this method returned true and eventMouseUp handler was not called in ext.utils.dragdrop.js
...
var pageDimmer = {
    ...
    show: function(owner) {
        ...
        owner && owner.match(layoutModule.DIALOG_PATTERN) && this.setZindex(owner.getStyle('zIndex') - 1);
    },
