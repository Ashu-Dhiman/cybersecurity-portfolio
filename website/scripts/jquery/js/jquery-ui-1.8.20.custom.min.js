...
(function( $, undefined ) {
    ...
    function Datepicker() {
        ...
        this._mainDivId = 'ui-datepicker-div-1-8-20'; // The ID of the main datepicker division
    ...
    $.extend(Datepicker.prototype, {
        ...
        _hideDatepicker: function(input) {
            ...
            if (inst && this._get(inst, 'standalone')) {
                var onStandaloneClose = this._get(inst, 'onStandaloneClose');
                if (onStandaloneClose)
                    onStandaloneClose.apply((inst.input ? inst.input[0] : null),
        ...
        _selectDate: function(id, dateStr) {
            ...
            var fn = this._get(inst, 'onUpdateDate');
            if (fn) {
                fn.apply(window, [dateStr]);
            }
        ...
        _generateHTML: function(inst) {
            ...
            var controls = ((!inst.inline || this._get(inst, 'standalone')) ? '<button type="button" class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" onclick="DP_jQuery_' + dpuuid +
